...
class comment_models
{
    ...
    public function addComment($postId, $user, $commentText) {
        $date = date('Y-m-d H:i:s'); // date et heure actuelles au format "Y-m-d H:i:s"
    ...
    // Fonction pour récupérer les commentaires pour une publication donnée
    public function getCommentsForPost($postId) {
      //sélectionner les commentaires associés à une publication
        $query = "SELECT c.id_com, c.texte_com, c.date_com,  u.image_profil, u.username AS auteur_com
          FROM comments c
