...
<div class="wrapper">
    <nav>
        ...
        <div class="menu-item">
            <i class="fa-solid fa-message"></i>
            <a class="btn-menu" href="msgpriv.php">Messages</a>
        </div>
        <div class="menu-item">
            <i class="fa-solid fa-user"></i>
            <a class="btn-menu" href="AfficherProfil.php">Profile</a>
        </div>
        <div class="menu-item">
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            ...
            <form class="post-style" action="../control/post_controller.php" method="post" enctype="multipart/form-data">
                ...
                <input class="submit-button" type="submit" value="Créer le Post" name="Envoyer">
            </form>
        </div>
    </div>
    ...
    <section class="post-principal">
        <div class="post-search">
            <form class="post-style" action="accueil.php" method="post">
                ...
                <button name="rechercher_post" type="submit">Rechercher</button>
            </form>
            <button id="reset_filtres">Réinitialiser les filtres</button>
        </div>
        <script>
        ...
        foreach (array_reverse($posts) as $post) {
            ...
            if (($post->getAuteur() == $userId) | ($result['is_admin'] == 1)) {
        ...
        <script>
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', (event) => {
                    ...
                    if (confirmation) {
                        window.location.href = '../control/user_controller.php?suprId=' + postID;
