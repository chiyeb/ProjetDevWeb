...
<head>
    ...
    <link rel="stylesheet" href="../css/stylesMsg.css">
    <meta charset="UTF-8">
    <meta name="viewport"
    ...
    <div class="afficher-msg">
        ...
        for ($i = count($messages) - 1; $i >= 0; $i--) {
            ...
            echo "<div class='msg-auteur'>
                ...
                <p class='auteurmsg'>" . $message->getAuteur() . "</p>
                </div>";#afficher l'id de l'auteur

            echo "<div class='msg-receveur'>
                <i class='fa-solid fa-at''></i>  
                <p class='receveurmsg'>" . $message->getReceveur() . "</p>
                </div>";#afficher l'id de celui qui reçoit le msg
